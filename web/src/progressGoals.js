...
export const PROGRESS_GOALS = [
  ...
  },
  {
    id: "five_paths",
    title: "天门前五卷",
    hook: "完成五章主线，抵达太虚天门，让玩家先拿到第一段大目标回响。",
    target: 5,
  ...
  },
  {
    id: "ten_routes",
    title: "十卷破潮",
    hook: "完成十章主线，从星砂驿追到龙门断潮，证明第二部不只是余波。",
    target: 10,
    reward: { jade: 360, spirit: 10, xp: 80, epithet: "十卷破潮" },
    metric: (profile) => Math.min(10, completedStoryChapters(profile).size),
  },
  {
    id: "fifteen_trials",
    title: "十五卷炼心",
    hook: "完成十五章主线，跨过王庭、机关城、雾海与赤炉，形成真正的中盘征程。",
    target: 15,
    reward: { jade: 460, spirit: 12, xp: 100, epithet: "十五卷炼心" },
    metric: (profile) => Math.min(15, completedStoryChapters(profile).size),
  },
  {
    id: "twenty_witness",
    title: "二十卷见证",
    hook: "完成二十章主线，带着青鸾、碑林、万灯与太岁的证词逼近天书裂隙。",
    target: 20,
    reward: { jade: 560, spirit: 15, xp: 130, epithet: "二十卷见证" },
    metric: (profile) => Math.min(20, completedStoryChapters(profile).size),
  },
  {
    id: "twenty_five_free_world",
    title: "二十五卷自在",
    hook: "完成二十五章主线，把命册之后的所有答案交还人间。",
    target: 25,
    reward: { jade: 760, spirit: 20, xp: 180, epithet: "自在终卷" },
    metric: (profile) => Math.min(25, completedStoryChapters(profile).size),
  },
  {
    id: "hundred_cards",
    title: "百术入卷",
  ...
  },
  {
    id: "casebooks",
    title: "诸卷证据",
    hook: "带回五十条跨局调查证据，让二十五章宗卷不只是章节标题。",
    target: 50,
  ...
  },
  {
    id: "grand_casebooks",
    title: "百证成宗",
    hook: "累计一百条调查证据，补全从青岚谷到自在人间的核心真相链。",
    target: 100,
    reward: { jade: 360, spirit: 12, xp: 90, epithet: "百证宗师" },
    metric: (profile) => CHAPTERS.reduce((sum, chapter) => sum + (profile.investigationArchive?.[String(chapter.id)] || []).length, 0),
  },
  {
    id: "build_atlas",
