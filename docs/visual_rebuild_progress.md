...
- Card image budget pass: standardized project-bound generated card art to 640×960 with a stricter card-specific gate, reducing the Web generated-image payload while preserving mobile/PC card readability.
